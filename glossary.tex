...
\newglossaryentry{helm}{
    name = {Helm},
    description = {A package manager for Kubernetes that simplifies the deployment and management of applications by using charts, which are pre-configured Kubernetes resources.}
}

\newglossaryentry{apibinding}{
    name = {APIBinding},
    description = {A mechanism to import an exported API into a workspace.}
}

\newglossaryentry{apiexport}{
    name = {APIExport},
    description = {An object that exports an API from a workspace so others can bind it.}
}

\newglossaryentry{ingress}{
    name = {ingress},
    description = {L7 HTTP(S) routing into the cluster.}% chktex 36
}

\newglossaryentry{kustomize}{
    name = {Kustomize},
    description = {A tool for customizing Kubernetes YAML configurations.}
}

\newglossaryentry{metallb}{
    name = {MetalLB},
    description = {A load-balancer implementation for bare metal Kubernetes clusters.}
}
...
\newglossaryentry{gatling}{
    name = {Gatling},
    description = {A powerful open-source load testing tool for web applications.}
}

\newglossaryentry{grafana}{
    name = {Grafana},
    description = {An open-source platform for monitoring and observability that integrates with various data sources.}
}

\newglossaryentry{opentelemetry}{
    name = {OpenTelemetry},
    description = {An open-source observability framework for cloud-native software, providing APIs and SDKs for distributed tracing and metrics collection.}
}

\newglossaryentry{loki}{
    name = {Loki},
    description = {A log aggregation system designed to work seamlessly with Grafana, allowing for the collection and visualization of logs from various sources.}
}

\newglossaryentry{k6}{
    name = {k6},
    description = {A modern load testing tool built for developers, allowing for easy scripting of performance tests in JavaScript.}
}