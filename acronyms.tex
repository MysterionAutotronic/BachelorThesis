...
\newacronym{tmc}{TMC}{Transparent Multi Cluster}
\newacronym{kind}{kind}{Kubernetes IN Docker}
...
\newacronym{mcr}{MCR}{multicluster-runtime}
\newacronym{red}{RED}{Rate, Error, Duration}
\newacronym{kuard}{KUARD}{kubernetes-up-and-running demo}
