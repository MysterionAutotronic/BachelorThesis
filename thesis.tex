            ...
            \paragraph{The Challenges of Multi-Tenancy and the Need for Solutions}
                ...
                \begin{enumerate}[label={[\arabic*]:},
                    ...
                    \item\label{chal:isolation}
                        ...
                        As noted by~\cite[p.~195]{krebs2013} ``A system is said to be performance
                        isolated, if for tenants working within their quotas the performance is
                        within the (response time) SLA while other tenants exceed their quotas
                        (e.g., request rate)''
