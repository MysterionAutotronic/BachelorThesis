...
% % listings macros
% \newcommand{\CodePostbreak}{\mbox{\textcolor{gray}{\(\hookrightarrow\)}\space}}
    ...
    \appendix
        ...
        \section{TenantFE (Selected Code)}\label{app:tenantfe}
            ...
            \subsection*{Key Files}
                % API routes
                \begin{listing}[H]
                    \caption{API route: \texttt{src/app/api/config/route.ts}}
                    \label{lst:tenantfe-config-route}
                    \inputminted[
                        fontsize=\small,
                        linenos,
                        breaklines,
                ...
                \begin{listing}[H]
                    \caption{API route: \texttt{src/app/api/crash/route.ts}}
                    \label{lst:tenantfe-crash-route}
                    \inputminted[
                        fontsize=\small,
                        linenos,
                        breaklines,
                ...
                % Pages and libs
                \begin{listing}[H]
                    \caption{Root page: \texttt{src/app/page.tsx}}
                    \label{lst:tenantfe-page}
                    \inputminted[
                        fontsize=\small,
                        linenos,
                        breaklines,
            ...
            %         style=code,
            %         language=TSX,
            %         caption={Config provider: \texttt{src/lib/ConfigProvider.tsx}},
            %         label={lst:tenantfe-configprovider}
            %     ]{code/BachelorThesis_TenantFE/tenant_fe/src/lib/ConfigProvider.tsx}

            %     % layout
            %     \lstinputlisting[
            %         style=code,
            %         language=TSX,
            %         caption={Layout: \texttt{src/app/layout.tsx}},
            %         label={lst:tenantfe-layout}
            %     ]{code/BachelorThesis_TenantFE/tenant_fe/src/app/layout.tsx}

            % \subsection*{Build and Runtime}
            %     \lstinputlisting[
            %         style=code,
            %         language=Dockerfile,
            %         caption={TenantFE Dockerfile},
            %         label={lst:tenantfe-dockerfile}
            %     ]{code/BachelorThesis_TenantFE/Dockerfile}
