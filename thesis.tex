...
\begin{document}
    ...
    \appendix
        ...
        \clearpage
            ...
            \subsection*{Layout}
                \begin{tabularx}{\textwidth}{@{}>{\raggedright\arraybackslash}p{0.22\textwidth} X >{\raggedright\arraybackslash}p{0.34\textwidth}@{}}
                    ...
                    All Kubernetes and KCP artifacts (CRDs, RBAC, workspaces, deployments, ingress) &
                    ...
                    Automation: setup, build, cluster+workspace creation, TMC bootstrap, utilities &
        ...
        \clearpage
            ...
            \subsection*{Simplified Deployment Workflow}
                \begin{enumerate}
                    \item \textbf{Bootstrap tools} (kubectl, krew, plugins, kind, etc.): \\
        ...
        \clearpage
            ...
            \subsection*{Build and Images}
                ...
                \codesummary
                    ...
                    {Bash script building the dashboard \gls{be} image.}
        ...
        \clearpage
                ...
                \codesummary
                    ...
                    {Bash script that requires and \gls{api} \gls{url} as build argument. Builds the \gls{fe}.}
        ...
        \clearpage
            ...
            \subsection*{Workspaces}
                ...
                \codesummary
                    ...
                    {Exports plugin paths, creates \gls{kcp} workspaces (:root, dashboard, tenants), spins up a kind cluster, builds/loads \gls{fe} + \gls{be} images, applies deployments / services, grants \gls{rbac}, generates+applies the \gls{tmc} syncer, binds compute, and applies standard APIBindings.}
                    {Provisioning glue between control plane (\gls{kcp} workspaces) and data plane (kind). It installs and wires the dashboard stack that operators use to manage tenant configs.}
        ...
        \clearpage     
            ...
            \subsection*{Ingress}
                ...
                \end{flushleft}
                \codesummary
                    {Expose the dashboard UI and API via friendly local hostnames, mirroring production routing.}
        ...
        \clearpage
            ...
            \subsection*{Helpers}
                ...
                \codesummary
                    ...
                    {Local networking shim so dashboard and \gls{api} hostnames resolve to the kind node / ingress \gls{ip} on the developer machine.}
        ...
        \clearpage
                ...
                \codesummary
                    ...
                    {Runs \texttt{kind export kubeconfig} for \texttt{dashboard} and \texttt{tenant-1}, merging credentials into the active kubeconfig.}
