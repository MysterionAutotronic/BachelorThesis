    ...
    \section{Fundamentals}
        ...
        \subsection{Kubernetes and Multi-Tenancy}
            ...
            \paragraph{Background: The Evolution of Kubernetes}
                ...
                container orchestration in the tech industry (Damarapati, 2025; -, 2024).
                \\
                The evolution of Kubernetes parallels significant advancements in cloud computing
                and the surge in containerization practices, which enable developers to encapsulate
                their applications and dependencies within lightweight containers.
                This evolution has fostered an ecosystem promoting faster deployment cycles and
                optimized resource allocation, crucial for businesses aiming to innovate rapidly
                (Şenel et al., 2023)-, 2020).
                As a response to growing adoption, leading cloud providers have integrated
                Kubernetes into their services, offering Containers as a Service (CaaS),
                thus contributing to its widespread usage across various sectors
                (Şenel et al., 2023).
                \\
                Over the years, Kubernetes has also adapted to encompass diverse workloads,
                catering to both traditional applications and new paradigms such as Edge Native
                computing (Biot et al., 2025; Aruna & Gurunathan, 2024).
                ...
                Furthermore, the Kubernetes community plays a vital role in its growth, providing a
                rich library of extensions and tools that enhance its capabilities and address
                various challenges faced, such as workload scheduling and resource provisioning in
                diverse environments (Rejiba & Chamanara, 2022; Truyen et al., 2019).
