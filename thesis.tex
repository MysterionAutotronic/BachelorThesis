    ...
    \section{Conceptual Design}\label{sec:concept}
        ...
        \subsection{Architecture Design with KCP for SaaS}\label{subsec:architectureDesign}
            ...
            \subsubsection{Overview and Design Principles}\label{subsubsec:architectureOverview}
                ...
                These principles translate into the logical layout in \autoref{fig:system-architecture}.
                \vspace{0.5cm}
                \begin{figure}[H]
                    \centering
            ...
            \subsubsection{Workspace Topology and Multi-Tenancy model}
                ...
                \begin{table}[H]\label{tab:layersOverview}
                    ...
                    \begin{tabular}{lcp{4cm}P{8cm}}
                        ...
                        \midrule
                        Parent (control) & Workspace (\texttt{root}) & Deployment / dashboard, dashboard-\gls{api} & 1 (static) \\
            ...
            \subsubsection{Rationale for Config Injection Strategy}\label{subsubsec:rationale}
                The tenant-specific configuration is injected directly into the \gls{api} container
                at build time using \gls{docker} \texttt{--build-arg}, and deployed into the tenant
                workspace.
                This decision favors strong workspace isolation, avoids runtime complexities, and
                simplifies the tenant lifecycle.
                \\
