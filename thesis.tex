        ...
        \subsection{Automated Deployment Strategies}\label{subsec:deploymentStrategies}
            ...
            \subsubsection{Continuous Deployment}\label{subsubsec:continuousDeployment}
                ...
                \subsubsection{Zero-Downtime Rollout}\label{subsubsec:zeroDowntime}
                    Both continuous-deployment pipelines create a parallel deployment
                    (\texttt{-green}) alongside the live one (\texttt{-blue}) and wire then through
                    the same Cluster.
                    TODO: Source for Blue-Green.
                    TODO: Source for canary.
                    The Tekton post-deploy task then:
