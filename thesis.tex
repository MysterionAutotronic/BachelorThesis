...
\newcommand{\file}[1]{\textcolor{blue}{#1}}
    ...
    \appendix
        ...
        \section{TenantFE (Selected Code)}\label{app:tenantfe}
            ...
            \begin{figure}[H]
                ...
                ]{trees/BachelorThesis_TenantFE.trimmed.tree}
        ...
        \section{TenantBE (Selected Code)}\label{app:tenantbe}
            ...
            \begin{figure}[H]
                ...
                \VerbatimInput[
                    ...
                    obeytabs=true, showtabs=false,
                    showspaces=false, frame=single
                ]{trees/BachelorThesis_TenantBE.trimmed.tree}
        ...
        \section{ConfigSchema}\label{app:configschema}
            ...
            \begin{figure}[H]
                ...
                \VerbatimInput[
                    ...
                    obeytabs=true, showtabs=false,
                    showspaces=false, frame=single
                ]{trees/BachelorThesis_ConfigSchema.trimmed.tree}
        ...
        \section{DashboardFE (Selected Code)}\label{app:dashboardfe}
            ...
            \begin{figure}[H]
                ...
                \VerbatimInput[
                    ...
                    obeytabs=true, showtabs=false,
                    showspaces=false, frame=single
                ]{trees/BachelorThesis_DashboardFE.trimmed.tree}
        ...
        \section{DashboardBE (Selected Code)}\label{app:dashboardbe}
            ...
            \begin{figure}[H]
                ...
                \VerbatimInput[
                    ...
                    obeytabs=true, showtabs=false,
                    showspaces=false, frame=single
                ]{trees/BachelorThesis_DashboardBE.trimmed.tree}
        ...
        \section{Infra (Scripts and Manifests)}\label{app:infra}
            ...
            \VerbatimInput[
                ...
                formatcom=\ttfamily\small
            ]{trees/BachelorThesis_Infra.trimmed.tree}
