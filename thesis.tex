    ...
    \section{Fundamentals}
        ...
        \subsection{Kubernetes and Multi-Tenancy}
            ...
            \paragraph{Background: The Evolution of Kubernetes}
                ...
                supporting everything from conventional applications to emerging Edge-Native
                deployments \parencites[p.~21]{biot2025}[pp.~1--4]{biot2025}.
                \textit{Edge-native} deployments are applications intended to run on computing
