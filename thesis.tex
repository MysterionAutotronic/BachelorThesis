...
\begin{document}
    ...
    \section{Fundamentals}
        ...
        \subsection{Kubernetes and Multi-Tenancy}\label{subsec:k8sAndMultiTenancy}
            ...
            \subsubsection{Kubernetes Control Plane (KCP) as a Promising Approach}\label{subsubsec:kcpApproach}
                \gls{kcp} offers three capabilities that map cleanly onto today's \gls{multiTenancy}
                pain points.
            ...
            \subsubsection{Background: The Evolution of Kubernetes}\label{subsubsec:k8sEvolution}
                ...
                readiness caused by \gls{ha@gls}, disaster recovery and security.
                \\
            ...
            \subsubsection{Background: Containerization as an Enabler of Kubernetes}\label{subsubsec:containerization}
                ...
                enabling vertical and horizontal autoscaling facilitated by quick \gls{container}
                boot times, along with self-healing mechanisms and support for distributed,
            ...
            \subsubsection{Background: Kubernetes Resource Isolation Mechanisms}\label{subsubsec:k8sResourceIsolation}
                ...
                use of \textit{\gls{cgroups}} (control groups) and \textit{namespaces} to limit
                ...
                \gls{multiTenancy} \parencite[p.~651]{nguyen2022} and research indicates that the
                native isolation strategies can lead to performance interference, where containers
                that share nodes can experience significant degradation in performance due to CPU
                contention \parencite[p.~158]{kim2021}.
    ...
    \section{Conceptual Design}\label{sec:concept}
        ...
        \subsection{Proposed Scenario}\label{subsec:scenario}
            ...
            light-weight yet realistic multi-tenant scenario:
            \\
        ...
        \subsection{System Requirements}\label{subsec:requirements}
            ...
            \subsubsection{Functional Requirements}\label{subsubsec:fr}
                \begin{table}[ht]\label{tab:fr}
                    \centering{}
                    \renewcommand{\arraystretch}{1.5}
                    \begin{tabular}{lcp{5cm}P{8cm}}
                        \toprule
            ...
            \subsubsection{Non Functional Requirements}\label{subsubsec:nfr}
                ...
                \begin{table}[ht]\label{tab:nfr}
                    ...
                    \begin{tabular}{lcp{5cm}P{8cm}}
                        ...
                        \midrule
                        \hypertarget{nf1}{NF-1} & T & Test & TestDescription \\
                        \bottomrule
                    \end{tabular}
